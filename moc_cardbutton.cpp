...
#include "../CardMatchingGame/cardbutton.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSCardButtonENDCLASS_t qt_meta_stringdata_CLASSCardButtonENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(11, 11),  // "cardClicked"
        QT_MOC_LITERAL(23, 0),  // ""
        QT_MOC_LITERAL(24, 11),  // "CardButton*"
...
void CardButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CardButton::*)(CardButton * );
            if (_t _q_method = &CardButton::cardClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CardButton::cardClicked(CardButton * _t1)
{
